define(['Phaser','game','endStageManager','Enemy','Gastly','Machop','lifeManager'], function (Phaser,Game,endStageManager,Enemy,Gastly,Machop,lifeManager){ 
    ...
    DungeonStage.prototype.create = function() {
        //contador de victoria valida
        this.waitWin = 0;
        //emisor para el fuego
        ...
        this.stage1 = Game.add.text(50, 200, 'Nivel 1: Mazmorra',{ font: 'bold 36px Geo', fill: '#FFFFFF' });
        this.stage1.alpha = 1;
        Game.add.tween(this.stage1).to({alpha:0},4000).start();
        
        /////////////////
        //ANADIR PERSONAJES
        this.player1 = Game.add.sprite(55, 250,'player1');
        this.player2 = Game.add.sprite(30, 250,'player2');
        this.player3 = Game.add.sprite(10, 250,'player3');       
        ...
        //anadimos los pokemon obstaculos
        this.steelix = Game.add.sprite(720, 240,'steelix');
        ...
        this.onix = Game.add.sprite(880, 0,'onix');
        ...
        this.goal = Game.add.sprite(1830, 420,'goal');
        ...
        this.dungeonBSO=Game.add.audio('dungeonBSO');
        this.endStageSound=Game.add.audio('endStage');        
        this.dungeonBSO.loopFull(); 
        
        this.createWorld();        
    }
    //funcion de manejo de la pausa
    DungeonStage.prototype.togglePause= function() {
        ...
        if(this.paused){
            ...
            //anadimos letras para manejar menu
    ...
    DungeonStage.prototype.enterMenu = function() {
        if(this.posPause==0){
            this.togglePause();
        }else{
    ...
    DungeonStage.prototype.twoPauseMenu = function() {
        this.pokeIco.position.x=Game.camera.x+220;
        this.pokeIco.position.y=Game.camera.y+265;
        this.posPause=1;
    }
    
    DungeonStage.prototype.update= function() {
        Game.world.bringToTop(this.stage1);
        ...
        //iniciamos la rutina de los enemigos
        for (i=0; i< this.enemies.length; i++){
        ...
        //comprobamos cuando el fuego toca a un enemigo para lanzar el emitter
        for (i=0; i< this.enemies.length; i++){
        ...
        if(this.isOver==false){
            this.endStageManagerGame.checkEndStage(this,1500,this.world.centerY+130,this.dungeonBSO);       
        }        
    }
        
    DungeonStage.prototype.selectPlayer= function() {
    ...
    DungeonStage.prototype.movePlayer= function() {
    ...
    DungeonStage.prototype.skillPlayer= function() {
        //si se hace la cepa
    ...
    DungeonStage.prototype.createWorld= function() {
        // Create the tilemap
        this.map = Game.add.tilemap('dungeonStageTilemap');
        // Add the tileset to the map
        this.map.addTilesetImage('mazmorra');       
        this.map.addTilesetImage('fondoMazmorra');       
        ...
        this.map.setCollisionBetween(0, 5473);
        ...
        this.enemies.push(new Gastly(Game,200, 500));        
    }
    
    //Reiniciamos el nivel cuando muere un personaje
    DungeonStage.prototype.playerDie= function() {
        ...
        //ajustams el alfa para mostrar la inmortalidad
    ...
    //funcion que provoca el emitter cuando se quema a onix
    DungeonStage.prototype.quemaOnix= function(fire, onix) {
        Game.world.bringToTop(this.emitter);
    ...
    //funcion que provoca el emitter cuando se quema a onix
    DungeonStage.prototype.quemaSteelix= function(fire, steelix) {
        Game.world.bringToTop(this.emitter);
  ...
  //Función para crear un delay en nuestro emisor de partículas
    DungeonStage.prototype.startMenu= function() {
        Game.state.start('menuState');
    }
    
   DungeonStage.prototype.restartGame= function() {
